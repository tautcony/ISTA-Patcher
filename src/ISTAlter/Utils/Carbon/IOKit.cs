...
internal partial class IOKit
{
    ...
    internal static partial IntPtr IOServiceMatching([In] byte[] name);
    ...
    [LibraryImport("/System/Library/Frameworks/IOKit.framework/IOKit")]
    internal static partial IntPtr IOServiceGetMatchingService(IntPtr masterPort, IntPtr matchingDictionary);
    ...
    [LibraryImport("/System/Library/Frameworks/IOKit.framework/IOKit")]
    internal static partial IntPtr IORegistryEntryCreateCFProperty(IntPtr entry, IntPtr key, IntPtr allocator, uint options);
}
