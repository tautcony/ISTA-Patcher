...
using ISTA_Patcher.Models.Rheingold.LicenseManagement;
...
internal static class Program
{
    ...
    public static Task<int> Main(string[] args)
    {
        ...
        var command = ProgramArgs.BuildCommandLine(
            RunPatchAndReturnExitCode,
            RunCerebrumancyOperationAndReturnExitCode,
            RunDecryptAndReturnExitCode,
            RunILeanAndReturnExitCode);
    ...
    private static async Task<int> RunILeanAndReturnExitCode(ProgramArgs.ILeanOptions opts)
    {
        LevelSwitch.MinimumLevel = opts.Verbosity;
